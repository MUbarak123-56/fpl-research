...
st.subheader("Analyzing Premier League Outcomes and FPL Data")
    ...
    st.write("""
    For our analysis, we compiled data from various sources, focusing on team performance metrics and individual player scores from the FPL. This involved cleaning the data, handling missing values, and preparing features to understand the dynamics of the game outcomes and player performances.
    """)
    
    # FPL Performance Analysis
    st.header("FPL Performance Analysis")
    st.write("""
    We compared the real match outcomes with the performance scores assigned by the FPL app, identifying discrepancies and patterns. This analysis helps in understanding how individual player performances correlate with the overall team success in the league.
    """)
